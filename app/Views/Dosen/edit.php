...
<body>
    <div class="container">
        ...
        <form method="post" action="/si-akademik/public/dosen/update?id=<?= htmlspecialchars($dosen['id']) ?>">
            <label>NIDN</label><br>
            <input type="text" name="nidn" value="<?= htmlspecialchars($dosen['nidn']) ?>" required><br>

            <label>Nama</label><br>
            <input type="text" name="nama" value="<?= htmlspecialchars($dosen['nama']) ?>" required><br>

            <label>Bidang Keahlian</label><br>
            <input type="text" name="bidang_keahlian" value="<?= htmlspecialchars($dosen['bidang_keahlian']) ?>" required><br>
